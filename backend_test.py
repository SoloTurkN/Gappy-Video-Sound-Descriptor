    ...
    def __init__(self, base_url="https://scene-describe-1.preview.emergentagent.com"):
        ...
        self.test_users = {
            'free_user': {
                ...
                'email': f'transcript.tester.{unique_id}@testmail.com',
                'password': 'TestPass123!'
            },
            'pro_user': {
                'name': 'Caption Tester', 
                'email': f'caption.tester.{unique_id}@testmail.com',
...
def main():
    ...
    # Run all test suites
    all_tests = auth_tests + video_tests + transcript_tests + project_tests + usage_tests + export_tests + payment_tests + security_tests + cleanup_tests
